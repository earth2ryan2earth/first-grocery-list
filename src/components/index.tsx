...
interface ListItemProps {
  ...
  onDelete?: (item: GroceryList) => void;
}

const ListItemComponent: NextPage<ListItemProps> = ({ item, onUpdate, onDelete }) => {
  return (
    <div className="flex flex-row items-center justify-between border-b px-3">
      <div className="h-12 flex items-center justify-between px-3">
        <input
          type="checkbox"
          className="2-4 h-4 border-gray-300 rounder mr-4"
